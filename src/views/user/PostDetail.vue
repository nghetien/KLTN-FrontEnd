    ...
    <div class="post-detail">
        ...
        <div class="post-detail__container">
            <div class="post-detail__info">
                ...
                />
                <h6 class="post-detail__info-react">{{ postDetail.like - postDetail.dislike }}</h6>
                <CaretDownOutlined
                    @click="handleDislike"
                    :style="{
                        color: like === -1 ? 'var(--primary)' : 'var(--grey)',
            ...
            <div class="post-detail__view">
                <div class="post-detail__view-info">
                    <div class="post-detail__view-user">
                        ...
                        <a-button type="primary" ghost>Theo dõi</a-button>
                    </div>
...
<script>
    ...
    import { handleLikeResponse, toggleBookmarkResponse } from '../../services/method/post';
        ...
        setup() {
            ...
            const handleLike = async () => {
                ...
                if (res.status) {
                    if (like.value === 1) {
                        like.value = 0;
                        postDetail.value.like -= 1;
                    } else if (like.value === -1) {
                        postDetail.value.like += 2;
                        like.value = 1;
                    } else {
                        like.value = 1;
                        postDetail.value.like += 1;
